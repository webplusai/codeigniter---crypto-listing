...
if (!function_exists('my_base_url_4')) {
	function my_base_url_4() {
...
<head>
	...
	<title>Coinschedule - Error</title>

	<link rel="stylesheet" type="text/css" href="<?=my_base_url_4()?>public/css/404style.css">
</head>
<body>
		...
		<div class="nav-container">
			<div style="float: left;">
				...
				<div class="mediasquares inline">
					<div class="hide">
						<a href="<?=my_base_url_4()?>blog/" target="_blank">
					...
					<div>
						<a href="<?=my_base_url_4()?>slack.html" target="_blank">
			...
			<div class="nav inline">
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>">ICOs</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>#blog">Blog</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>#events">Events</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>icos.html">Results</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>stats.html">Stats</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>submit_entry.html">Submit</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>advertise.html">Advertise</a></div>
				<div class="nav-item inline"><a href="<?=my_base_url_4()?>login.html">Login</a></div>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
	...
	<div class="footer">
		<div class="footer-col inline top">
			<h4>Website</h4>
			<a href="<?=my_base_url_4()?>">Home</a>
			<a href="<?=my_base_url_4()?>about.html">About</a>
			<a href="<?=my_base_url_4()?>submit_entry.html">Submit Entry</a>
			<a href="<?=my_base_url_4()?>advertise.html">Advertise</a>
			<a href="<?=my_base_url_4()?>login.html">Login</a>
		</div>
		<div class="footer-col inline top">
			<h4>Tools</h4>
			<a href="<?=my_base_url_4()?>icos.html">Results</a>
			<a href="<?=my_base_url_4()?>stats.html">Stats</a>
			<a href="https://developers.coinschedule.com/" target="_blank">Developers (API)</a>
		</div>
		<div class="footer-col inline top">
			<h4>Media</h4>
			<a href="<?=my_base_url_4()?>blog">Blog</a>
			<a href="<?=my_base_url_4()?>press.html">Press Mentions</a>
		...
		<div class="footer-col inline top">
			<h4>Legal</h4>
			<a href="<?=my_base_url_4()?>terms.html">Terms</a>
			<a href="<?=my_base_url_4()?>disclaimer.html">Disclaimer</a>
			<a href="<?=my_base_url_4()?>privacypolicy.html">Privacy Policy</a>
			<a href="<?=my_base_url_4()?>cookies_policy.html">Cookie Policy</a>
		</div>
	</div>
	...
	<div class="copyright">
		...
		<div class="inline dmca">
			<a href="//www.dmca.com/Protection/Status.aspx?ID=18ff9b78-666a-445b-8b50-96af4895f2a0" title="DMCA.com Protection Status" class="dmca-badge" target="_blank">
				<img src="<?=my_base_url_4()?>public/images/img/dmca-badge-w150-5x1-08.png" alt="DMCA.com Protection Status">
			</a>
